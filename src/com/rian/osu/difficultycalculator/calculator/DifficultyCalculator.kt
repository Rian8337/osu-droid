...
object DifficultyCalculator {
    ...
    fun calculateTimed(
        ...
        if (beatmapToCalculate.hitObjects.getObjects().isEmpty()) {
            return attributes
        }
        ...
        progressiveBeatmap.hitObjects.add(beatmapToCalculate.hitObjects.getObjects().first())
    ...
    private fun processCS(difficulty: BeatmapDifficulty, parameters: DifficultyCalculationParameters?) {
        parameters?.mods?.apply {
            ...
            if (GameMod.MOD_SMALLCIRCLE in this) {
                difficulty.cs += 4
            }
        }
    ...
    private fun createDifficultyHitObjects(
        ...
        beatmap.hitObjects.getObjects().let {
